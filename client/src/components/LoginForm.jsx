...
export default function LoginForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // LocalStorage-based login (no backend)
      ...
      setSuccess(true)
      localStorage.setItem("user", JSON.stringify({ email: found.email, username: found.username || "" }))
      setEmail("")
      setPassword("")
      ...
      <div className="bg-card rounded-lg border border-border p-8 shadow-sm">
        ...
        {success && (
          <div className="mb-4 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-md">
            <p className="text-green-800 dark:text-green-300 text-sm">Sign in successful! Redirecting...</p>
          </div>
        )}
